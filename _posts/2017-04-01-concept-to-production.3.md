...
<p> We needed to develop a technical infrastructure to support a delivery service for kids at school. In the form of a monthly subscription, the parents can subscribe online and then, we will generate a personalized meal plan each month with an automatic payment.  </p>

<h2>How?</h2>

<strong>Market Researches</strong>

<p>While working on defining the concept and our offer, we’ve made some researches about our indirect competitors. Our goal was to understand our market/environment to define the best offer.</p>

<strong>User Flow Touchpoints</strong>

<p>Our product could only work if we had a proper understanding of our process. To be customer centric from the start, we’ve worked on this using the technique of user flows. In fact, it was easier for us to imagine the different contact points and anticipate the needs. </p>
...
<p>From the start, the goal is to give the control to the parents on what their kids eat. In fact, we will track for them from where the tomato come to which kid will eat it and we will tell them in real time when the kid eat. </p>
...
<p>We have started the whole project by wireframing on paper the whole website. How I wireframes? For each page, I define the key informations and then I place them on my page depending on the importance.  </p>
...
<p>After few weeks, we had our first real prototype ready and we’ve organised another focus group with external actors this time. </p>


<h2>Result</h2>

<p> As of today, we deliver 100+ lunches daily ! </p>
